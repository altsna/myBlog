        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center space-x-2 pt-8 xl:sticky xl:top-0">
            <Image
              ...
              width="192px"
              height="192px"
              className="h-48 w-48 rounded-full object-cover xl:rounded-full"
              placeholder="blur"
          ...
          <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
            <p>
              ...
              >
                I am a nutrition student pursuing my studies at Universitas Gadjah Mada located in
                Yogyakarta, Indonesia. I was born and raised in Bayan and have a passion for design
                and writing. In my free time, I love to create designs using Figma and write
                articles and blogs as a form of self-expression. I am fluent in both English and
                Indonesian.
              </RoughNotation>
            </p>
            <p className="sm:block md:hidden lg:hidden">
              ...
              <span className="font-semibold"> I am always looking to learn new things.</span>
              <RoughNotation
                type="underline"
                show={true}
                color="#FBCFE8"
                ...
                multiline={true}
              >
                Feel free to reach out if you have anything to talk about, you can reach me through{' '}
              </RoughNotation>
              <Link
                href={'mailto:maroyitas@gmail.com'}
